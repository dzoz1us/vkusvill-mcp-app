...
export default function OnboardingPage() {
  ...
  const { form, setFormField } = useAppStore();
  ...
  const validate = (): string[] => {
    ...
    if (form.people_count < 1)
      errs.push("Укажите количество человек (минимум 1)");
    if (form.days.length === 0) errs.push("Выберите хотя бы один день");
    if (form.budget <= 0) errs.push("Бюджет должен быть больше 0");
    if (form.appliances.length === 0)
      errs.push("Выберите хотя бы один вид кухонной техники");
    return errs;
  };
  ...
  const canProceed = () => {
    switch (step) {
      ...
      case 4:
        return true;
      case 5:
        return form.appliances.length > 0;
      default:
        return false;
    }
  };
              ...
              <div className="flex items-center justify-center gap-4">
                <button
                  onClick={() =>
                    setFormField(
                      "people_count",
                      Math.max(1, form.people_count - 1),
                    )
                  }
                ...
                <button
                  onClick={() =>
                    setFormField(
                      "people_count",
                      Math.min(10, form.people_count + 1),
                    )
                  }
                  className="w-12 h-12 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-xl font-bold text-gray-600 transition"
                >
          ...
          {step === 1 && (
            <div className="space-y-6">
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={() =>
                    setFormField("days", ["mon", "tue", "wed", "thu", "fri"])
                  }
                  className="text-xs px-3 py-1.5 rounded-lg bg-gray-100 text-gray-600 hover:bg-gray-200 transition"
                >
                  Будни
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Ориентировочная стоимость продуктов
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Выберите что вам важно (необязательно)
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Что у вас есть? (подберём подходящие рецепты)
                  </p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-3">
